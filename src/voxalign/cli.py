...
def build_parser() -> argparse.ArgumentParser:
    ...
    align = subparsers.add_parser("align", help="Align transcript to audio (placeholder)")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "align":
        print("Alignment pipeline not implemented yet.")
    ...
    if args.command == "serve":
        try:
            ...
            print("`voxalign serve` requires uvicorn. Install project dependencies first.", file=sys.stderr)
            return 1
